...
export const FeedbackCard: React.FC<FeedbackCardProps> = ({ project, idx = 0, onClick }) => {
  return (
    ...
    >
      ...
      <button className="w-full py-3 font-bold rounded-xl transition-all flex items-center justify-center gap-2 relative z-10 group-hover:shadow-lg bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white group-hover:shadow-blue-200">
